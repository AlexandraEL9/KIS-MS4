...
class TestReviewForm(SimpleTestCase):
    ...
    def test_form_with_missing_title(self):
        ...
        self.assertFalse(
            form.is_valid(),
            "The form should not be valid if the title is missing"
        )
        self.assertIn(
            'title',
            form.errors,
            "The form should contain errors for the missing title"
        )
    ...
    def test_form_with_missing_content(self):
        ...
        self.assertFalse(
            form.is_valid(),
            "The form should not be valid if the content is missing"
        )
        self.assertIn(
            'content',
            form.errors,
            "The form should contain errors for the missing content"
        )
    ...
    def test_form_with_invalid_rating(self):
        ...
        self.assertFalse(
            form.is_valid(),
            "The form should not be valid with an invalid rating"
        )
        self.assertIn(
            'rating',
            form.errors,
            "The form should contain errors for an invalid rating"
        )
