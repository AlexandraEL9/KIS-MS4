...
I decided to create an app which I tested throughout the development cycle, writing tests at key stages of the development, not just checking at the end.

| **Test Name** | **Point of Development** | **Test Type** | **Description** | **Result** | **Screenshot/ Info** |
|---|---|---|---|---|---|
...
<br >
The only repeated issues which cropped up involved line length, 2 line spaces instead of 1 and adding a blank line with no spaces at the end of the file.
...
| env.py | All clear, no errors found | [env.py](./docs/testing/python-linter/env-py.png)|
| **Keep_it_sweet** |  |  |
...
| checkout/tests/test_forms.py | All clear, no errors found | [checkout/tests/test_forms.py validation](./docs/testing/python-linter/checkout-tests-forms.png) |
| **Favourites app** |  |  |
...
| :-- | :-: | :-: | :-: | :-: | :-- |
| [' Current index.html'](/docs/testing/lighthouse-testing/homepage-desktop-5.png) | 81 | 98 | 100 | 90 | New scores are now all above 90%, withthe exception of 'Performance' (see above). Initial test results found here:['index.html'](/docs/testing/lighthouse-testing/homepage-desktop.png) |
...
| ['Current login.html'](/docs/testing/lighthouse-testing/login-desktop-4.png) | 76 | 98 | 100 | 90 | New scores are now all above 90%. Initial test results found here:['login.html'](/docs/testing/lighthouse-testing/login-desktop1.png) |
| ['Current add-product.html'](/docs/testing/lighthouse-testing/add-product-desktop-5.png) | 65 | 100 | 100 | 90 | Scores are above 90%. Initial test results found here: ['add-product.html'](/docs/testing/lighthouse-testing/add-product-desktop1.png) |
...
| ['Current bag.html'](/docs/testing/lighthouse-testing/bag-desktop-5.png) | 52 | 98 | 100 | 82 | Scores are above 90% on average, with the exception of 'Performance' (see above), and 'SEO' (Which is beyond the scope of this project). Initial test results found here:['bag.html'](/docs/testing/lighthouse-testing/bag-desktop1.png)  |
...
| ['Current favourites.html'](/docs/testing/lighthouse-testing/favourites-desktop-4.png) | 37 | 98 | 100 | 91 |  Scores are above 90% on average, with the exception of 'Performance' (see above) (Which is beyond the scope of this project). Initial test results found here:['favourites.html'](/docs/testing/lighthouse-testing/favourites-desktop.png) |
...
| ['Current contact.html'](/docs/testing/lighthouse-testing/contact-desktop-2.png) | 74 | 98 | 100 | 90 |  All scores above 90%, with the exception of 'Performance', (see above).  |

#### Mobile
| Page | Performance (%) | Accessibility (%) | Best Practices (%) | SEO (%) | If score is below 90% |
| :-- | :-: | :-: | :-: | :-: | :-- |
| ['Current index.html'](/docs/testing/lighthouse-testing/homepage-mobile-5.png) | 92 | 98 | 100 | 90 | New scores are now all above 90% apart from 'Performance' (see above) Initial test results found here: ['index.html'](/docs/testing/lighthouse-testing/homepage-mobile-1.png)    |
| ['Current subscribe.html'](/docs/testing/lighthouse-testing/subscribe-mobile-4.png) | 59 | 98 | 100 | 90 | New scores are now all above 90% apart from 'Performance' (see above) Initial test results found here:['subscribe.html'](/docs/testing/lighthouse-testing/subscribe-mobile1.png) |
...
| ['Current signup.html'](/docs/testing/lighthouse-testing/signup-mobile-6.png) | 84 | 98 | 100 | 90 | New scores are now all above 90% apart from 'Performance' (see above) Initial test results found here:['signup.html'](/docs/testing/lighthouse-testing/signup-mobile1.png) |
| ['Current login.html'](/docs/testing/lighthouse-testing/login-mobile-5.png) | 61 | 98 | 100 | 90 | New scores are now all above 90%. Initial test results found here:['login.html'](/docs/testing/lighthouse-testing/login-mobile1.png) |
| ['Current add-product.html'](/docs/testing/lighthouse-testing/add-product-mobile-5.png) | 66 | 100 | 100 | 90 | New scores are now all above 90% apart from 'Performance' (see above) Initial test results found here:['add-product.html'](/docs/testing/lighthouse-testing/add-product-mobile1.png) |
...
| ['Current product_detail.html'](/docs/testing/lighthouse-testing/product-detail-mobile-5.png) | 28 | 98 | 100 | 91 | New scores are now all above 90% apart from 'Performance' (see above) Initial test results found here:['product_detail.html'](/docs/testing/lighthouse-testing/product-detail-mobile1.png) |
...
| ['Current favourites.html'](/docs/testing/lighthouse-testing/favourites-mobile-6.png) | 28 | 98 | 100 | 82 | Scores are above 90% on average, with the exception of 'Performance' (see above), and 'SEO' (Which is beyond the scope of this project). Initial test results found here: ['favourites.html'](/docs/testing/lighthouse-testing/favourites-mobile.png)  |
...
| ['Current contact.html'](/docs/testing/lighthouse-testing/contact-mobile-2.png) | 62 | 98 | 100 | 90 |  All scores above 90%, with the exception of 'Performance', (see above).  |
...
| 5                 | Customer           | View the total amount of products in my shopping bag                 | Keep track of spending                                                   | Displayed a shopping bag summary in the navbar.                          | [user-story-5](./docs/testing/user-stories/user-story-5-updated.png)          |
| 6                 | Customer           | View customer reviews of previous Keep it Sweet customers            | Feel safe in the knowledge that I will be treated well as a customer and feel confident about my purchase. | Integrated a product review section below each product detail.           | [user-story-6](./docs/testing/user-stories/user-story-6-updated.png)                      |
...
| 9                 | Returning customer            | Easily log in and log out of my account                              | Access my personal information                                           | Added login/logout functionality using Django's authentication views.     | [user-story-9](./docs/testing/user-stories/user-story-9-updated.png)              |
| 10                | Returning/ frequent customer  | Have a personalised user profile                                     | Access my stored information, order history, and favourites.               | Developed a user profile page showing order history and a page for favourite items.   | [user-story-10](./docs/testing/user-stories/user-story-9-updated.png)             |
| **SORTING & SEARCHING**                                                                                                                                                                                                        |
...
| 15                | Customer           | View notifications/feedback when a product is added to the basket    | Receive immediate feedback if the action is completed                    | Implemented toast messages for add-to-basket actions.                     | [user-story-15](./docs/testing/user-stories/user-story-15-updated.png)                 |
| 16                | Customer           | View items in my basket to be purchased                              | Quickly see the total cost of items                                      | Created a shopping bag page with an itemized list of products.            | [user-story-16](./docs/testing/user-stories/user-story-16-updated.png)                                  |
| 17                | First time user           | Edit/update the items in my basket and adjust quantities             | Ensure my purchase is exactly what I want                                | Added functionality to update product quantities in the basket.           | [user-story-17](./docs/testing/user-stories/user-story-17-updated.png)                              |
| 18                | Customer           | Enter payment information                                            | Checkout with minimal fuss.                                              | Integrated Stripe payment gateway for secure checkout.                    | [user-story-18](./docs/testing/user-stories/user-story-18-updated.png)                 |
| 19                | Customer           | Receive confirmation of my order                                     | Know my payment has gone through and that my order is in the system.     | Displayed order confirmation on the success page.                         |   [user-story-19](./docs/testing/user-stories/user-story-19-updated.png)                          |
| **SITE ADMIN**                                                                                                                                                                                                                |
...
| **PRODUCT REVIEWS**                                                                                                                                                                                                          |
| 27                | Customer           | View reviews for a product I am viewing                              | Be made aware of previous customers' views                               | Link to reviews below product details on the product page.               | [user-story-27](./docs/testing/user-stories/user-story-6-updated.png)              |
...
| 1 | Access URL: https://keep-it-sweet-2ecaa2229785.herokuapp.com/ |Site shows home page including Nav & Search Bar, Account, site content & footer | As Expected | Pass | [desktop](./docs/testing/full-feature/feature-test-1-desktop.png), [tablet](./docs/testing/full-feature/feature-test-1-tablet.png), [mobile](./docs/testing/full-feature/feature-test-1-mobile.png) |
| **TOP HEADER LINKS** |  |  |  |  |   |
...
| 23 | Record Stored |  Subscription appears in admin panel   | As Expected | Pass | [23 Results](./docs/testing/full-feature/feature-test-23.png)   |
| **Bag** |  |  |  |  |   |
