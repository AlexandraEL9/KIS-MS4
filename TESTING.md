...
| **SITE ADMIN**                                                                                                                                                                                                                |
| 20                | Store Owner               | Add a product                                                        | Add new items to my store                                                | Built an admin panel for adding new products.                             | Screenshot of the product creation page in the admin panel.          |
| 21                | Store Owner               | Edit/update a product                                                | Amend a product's information so site info is up-to-date                 | Built an admin panel for editing product information.                     | Screenshot of the product editing page in the admin panel.           |
| 22                | Store Owner               | Delete a product                                                     | Remove items that are no longer for sale                                 | Added a delete option in the admin panel with confirmation prompts.       | Screenshot of the delete confirmation page.                           |
| **DIGITAL MARKETING**                                                                                                                                                                                                         |
| 23                | Store Owner               | Signpost customers to social media and newsletter                    | Build a community of repeat customers to drive sales                     | Added links to social media and newsletter signup in the footer.          | Screenshot of footer links for social media and newsletter.          |
| 24                | First time/returning user | Access social media and sign up for newsletter                       | Access special offers                                                    | Embedded a newsletter signup form and social media buttons.               | Screenshot of the signup form and social buttons.                    |
| **PRODUCT REVIEWS**                                                                                                                                                                                                          |
| 25                | First time user           | View reviews for a product I am viewing                              | Be made aware of previous customers' views                               | Displayed reviews below product details on the product page.               | Screenshot of the reviews section on the product page.               |
| 26                | Returning user            | Add my own reviews to purchased products                             | Share my experiences of a product I purchased                            | Enabled logged-in users to submit reviews.                                | Screenshot of the review submission form.                            |
| 27                | Returning user            | Edit my own reviews of purchased products                            | Maintain control of my published content                                 | Added an edit review option for logged-in users.                          | Screenshot of the edit review form.                                  |
| 28                | Returning user            | Delete my own reviews of purchased products                          | Maintain control of my published content                                 | Added a delete review option with confirmation prompts.                   | Screenshot of the delete review confirmation.                        |
| **USER FAVOURITES LIST**                                                                                                                                                                                                      |
| 29                | Returning user            | Add favourite products to a 'Faves-list'                             | Access quickly in the future for speedier purchase                       | Built a 'Favourites' feature allowing users to save products.             | Screenshot of the 'Add to Favourites' button and favourites list.    |
| 30                | Returning user            | Remove favourite products from a 'Faves-list'                        | Personalise my list to my own tastes                                     | Added a 'Remove from Favourites' button.                                  | Screenshot of the updated favourites list.                           |
